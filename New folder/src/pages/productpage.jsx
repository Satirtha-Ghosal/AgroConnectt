...
const ProductPage = () => {
  ...
  return (
    <div className="mt-20 max-w-6xl mx-auto px-4 space-y-10 pb-15 relative">
      ...
      {showQuantitySelector && (
        <div className="fixed bottom-14 left-0 right-0 bg-white border-t border-green-200 shadow-md px-4 py-4 flex flex-col sm:flex-row justify-between items-center gap-4 z-50">
